    ...
    <body>
        ...
        <div class="wjContent clear" id="survey_page">
            ...
            <div id="question_box">
                ...
                <s:bean name="com.fivestars.websites.onlinetest.util.QuizSubjectVoComparator" id="quizSubjectVoComparator"></s:bean>
                
                <s:sort comparator="quizSubjectVoComparator" source="userQuizDetailVo.userQuizSubjectVoList">
                    <s:iterator id="quizSubjectVo">
                        <div class="wjques maxtop question jqtransformdone" id="">
                            <div class="title">
                                ${quizSubjectVo.quizSubject.question}
                            </div>
                            <div class="matrix">
                            <div class="red"></div>
                            <!-- single radio -->
                            <s:if test="#quizSubjectVo.quizSubject.type == 0">
                                <s:sort comparator="subjectItemComparator" source="#quizSubjectVo.subjectItems">
                                    <s:iterator id="subjectItem">
                                        <div class="radio">
                                            <label>
                                            	<s:if test="#quizSubjectVo.userAnswerVo.answer == #subjectItem.itemId">
                                            		<input type="radio" disabled="disabled" checked="checked" value="${subjectItem.itemId}" name="${quizSubject.subjectId}" /> ${subjectItem.choice }
                                            	</s:if>
                                            	<s:else>
                                            		<input type="radio" disabled="disabled" value="${subjectItem.itemId}" name="${quizSubject.subjectId}" /> ${subjectItem.choice }
                                            	</s:else>
                                            </label>
                                        </div>
                                    </s:iterator>
                            ...
                            <!-- multiple choice -->
                            <s:if test="#quizSubjectVo.quizSubject.type == 1">
                                <s:sort comparator="subjectItemComparator" source="#quizSubjectVo.quizSubject.subjectItems">
                                    <s:iterator id="subjectItem">
                                        <div class="checkbox">
                                            <label>
            ...
            <div class="feedbackContainer">
	            ...
	            <div class="wjhr mtop"></div>
	            <div class="feedbackContent wjintro mtop desc_begin">${userQuizDetailVo.feedBack.content}</div>
            </div>
        </div>
        <!-- JavaScript -->
